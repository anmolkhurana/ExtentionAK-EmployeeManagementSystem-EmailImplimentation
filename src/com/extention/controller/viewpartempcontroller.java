...
public class viewpartempcontroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public viewpartempcontroller() {
        super();
    }
	...
	{	try
	{
		...
		String Emp_Username = request.getParameter("e_uid");
		
		Statement st= con.createStatement();
		ResultSet rs;
		
		String selq = "Select emp.emp_username, emp.emp_password, empdata.emp_firstname, empdata.emp_lastname, empdata.emp_email,empdata.emp_contact, empdata.emp_dob from emp join empdata on emp.emp_username = empdata.emp_username where emp.emp_username ='" + Emp_Username + "'";
