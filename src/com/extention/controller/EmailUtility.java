...
public class EmailUtility 
{
	...
	{
		Properties properties = new Properties();//This is used for configuring the values. key/value pair. String values. 
		properties.put("mail.smtp.host",host);
		properties.put("mail.smtp.port", port);
		properties.put("mail.smtp.auth", "true");
		properties.put("mail.smtp.starttls.enable", "true");
		
		Authenticator auth= new Authenticator()//used for authentication purpose
				{
